  ...
  useEffect(() => {
    ...
    const loadProduct =
      async () => {
        ...
        const mainProduct = mainResult.data;
        ...
        if (
          initialAddOn &&
          initialAddOn.id !== mainProduct.id
        ) {
          setAddOnProduct(
            initialAddOn
          );
          ...
          >
            ...
            <div className="animate-detail-item opacity-0 translate-y-5 will-change-transform mt-6 border-t border-neutral-200 dark:border-neutral-800">
              ...
              <div className="border-b border-neutral-200 dark:border-neutral-800/60 py-4">
                ...
                {shippingExpanded && (
                  <div className="mt-4 text-sm text-neutral-600 dark:text-neutral-400 space-y-6 leading-relaxed">
                    ...
                    <div className="space-y-4">
                      ...
                      <p>
                        ...
                        , and all orders are shipped directly from Hong Kong.
                      </p>
                      ...
                      <p>
                        ...
                        before it is shipped. Once your order has been prepared, shipping time depends on your destination and the shipping service used.
                      </p>

                      <p>
                        For Hong Kong orders, we use{' '}
                        <strong className="text-neutral-900 dark:text-white">
                          Hong Kong Post or SF Express
                        </strong>
                        .
                      </p>
                      ...
                      <div className="space-y-3">
                        <div>
                          ...
                          <ul className="list-disc pl-5 mt-1 space-y-1">
                            <li>
                              Hong Kong Post: 3–7 business days
                            </li>
                            <li>
                              SF Express: 2–5 business days
                            </li>
                          </ul>
                        </div>
                      ...
                      <p>
                        Please note that delivery estimates are provided as a guide and may be affected by customs processing or local delivery conditions.
                      </p>

                      <p>
                        <strong className="text-neutral-900 dark:text-white">
                          Tracking is provided for all orders once your order has shipped.
                        </strong>{' '}
                        You will receive your tracking information so you can follow your order&apos;s journey.
                      </p>
                    </div>
                    ...
                    <div className="pt-2 space-y-5">
                      ...
                      <div className="space-y-2">
                        ...
                        <p>
                          If you ordered the wrong colour or rim specification, or simply changed your mind, we'll exchange it for you{' '}
                          <strong className="text-neutral-900 dark:text-white">
                            before your order is dispatched
                          </strong>
                          . Once your order has been shipped, exchanges are no longer available.
                        </p>
                      </div>
                      ...
                      <div className="space-y-2">
                        ...
                        <p>
                          If your kit arrives damaged, please contact us at{' '}
                          <a
                          ...
                          as soon as possible with photos of the item and packaging. We will review the issue and do our best to arrange a suitable solution.
                        </p>
                      </div>
                      ...
                      <div className="space-y-2">
                        ...
                        <p>
                          Email us at{' '}
                          <a
                            href="mailto:sales@lcpworks.com"
                            className="text-neutral-900 dark:text-white font-medium underline underline-offset-2 hover:opacity-70 transition-opacity"
                          >
                            sales@lcpworks.com
                          </a>{' '}
                          with a photo of the instruction page showing the missing part, your order number, and your address. We'll send the replacement once we've finished{' '}
                          <strong className="text-neutral-900 dark:text-white">
                      ...
                      <div className="space-y-2">
                        ...
                        <p>
                          We don't offer refunds to the original payment method for change-of-mind purchases. However,{' '}
                          <strong className="text-neutral-900 dark:text-white">
                            exchanges are available before your order is dispatched.
                          </strong>
                        </p>
                      </div>
                    </div>
